...
The pandoc template (`~/.config/opencode/skills/geo-seo/templates/geo-report-template.html`) injects:
...
pandoc GEO-AUDIT-REPORT.md \
  ...
  --standalone \
  --embed-resources \
  --template ~/.config/opencode/skills/geo-seo/templates/geo-report-template.html \
  --css ~/.config/opencode/skills/geo-seo/templates/geo-report-style.css \
...
- **Colors / typography** — Edit `~/.config/opencode/skills/geo-seo/templates/geo-report-style.css`
- **Cover layout** — Edit `~/.config/opencode/skills/geo-seo/templates/geo-report-template.html`
