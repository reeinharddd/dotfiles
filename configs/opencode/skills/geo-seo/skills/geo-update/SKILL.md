...
allowed-tools: read, grep, glob, bash, webfetch, write, edit, task
---
...
The GEO-SEO toolkit installs to these locations under `~/.config/opencode/skills/geo-seo/`:

| Component | Install Path |
|-----------|-------------|
| Main skill | `~/.config/opencode/skills/geo-seo/` |
| Sub-skills | `~/.config/opencode/skills/geo-seo/skills/geo-*/` |
| Agents | `~/.config/opencode/skills/geo-seo/agents/geo-*.md` |
| Scripts | `~/.config/opencode/skills/geo-seo/scripts/` |
| Schema templates | `~/.config/opencode/skills/geo-seo/schema/` |
| Hooks | `~/.config/opencode/skills/geo-seo/hooks/` |

Verify the installation exists by checking for `~/.config/opencode/skills/geo-seo/SKILL.md`. If it does not exist, inform the user that GEO-SEO is not installed and suggest running the installer instead.
...
- **Never modify `~/.config/opencode/opencode.json` or `~/.config/opencode/opencode.json`** — these are user configuration files, not part of the GEO-SEO toolkit.
